...
function Workflow() {
    return (
        <div className="w-full h-full flex flex-col items-center justify-center text-center">
            ...
            <p className="text-xs text-gray-700 dark:text-gray-300 mt-4"> figure 1. Matrix Designer</p>
            ...
            <p className="text-xs text-gray-700 dark:text-gray-300 mt-4"> figure 2. Workflow ERD</p>
...
function HypeShifts() {
    return (
        <div className="w-full h-full flex flex-col items-center justify-center text-center">
            ...
            <p className="text-xs text-gray-700 dark:text-gray-300 mt-4"> figure 1. HypeShifts Design</p>
            <p className="text-sm text-gray-700 dark:text-gray-300 mt-4 text-left">
            ...
            <p className="text-xs text-gray-700 dark:text-gray-300 mt-4"> figure 2. HypeShifts ERD</p>
            <p className="text-sm text-gray-700 dark:text-gray-300 mt-4">
...
function MassageBookingApp() {
    return (
        <div className="w-full h-full flex flex-col items-center justify-center text-center">
            ...
            <p className="text-xs text-gray-700 dark:text-gray-300 mt-2 mb-2"> figure 1. Homepage</p>
            <p className="text-sm text-gray-700 dark:text-gray-300 mt-4">
            ...
            <p className="text-xs text-gray-700 dark:text-gray-300 mt-2 mb-2"> figure 2. Booking page</p>
            <p className="text-sm text-gray-700 dark:text-gray-300 mt-4 text-left ml-2">
            ...
            <p className="text-xs text-gray-700 dark:text-gray-300 mt-2 mb-4"> figure 3. Service page</p>
            ...
            <p className="text-xs text-gray-700 dark:text-gray-300 mt-2 mb-4"> figure 4. Stripe payment method</p>
        </div>
    );
}
...
function DataVisualizations() {
    return (
        <div className="w-full h-full flex flex-col items-center justify-center text-center">
            ...
            <p className="text-xs text-gray-700 dark:text-gray-300 mt-2 mb-4"> figure 1. Average Temperature Map</p>
            <Image
            ...
            <p className="text-xs text-gray-700 dark:text-gray-300 mt-2 mb-4"> figure 2. Wildfires in Canada 2021</p>
            <Image
            ...
            <p className="text-xs text-gray-700 dark:text-gray-300 mt-2 mb-4"> figure 3. Wildfires in Alberta vs British Columbia</p>
        </div>
    );
}
...
function ArcGIS() {
    return (
        <div className="w-full h-full flex flex-col items-center justify-center text-center">
            ...
            <p className="text-xs text-gray-700 dark:text-gray-300 mt-2 mb-4"> figure 1. Cool Edmonton Raster based on population zones.</p>
            <Image
            ...
            <p className="text-xs text-gray-700 dark:text-gray-300 mt-2 mb-4"> figure 2. Alberta Highways</p>
            <Image
            ...
            <p className="text-xs text-gray-700 dark:text-gray-300 mt-2 mb-4"> figure 3. Alberta Retintroduction planting zones for wildfire affected plants</p>
        </div>
    );
}
...
function Workflow() {
    return (
        <div className="w-full h-full flex flex-col items-center justify-center text-center">
            ...
            <p className="text-xs text-gray-700 dark:text-gray-300 mt-2 mb-4"> figure 1. </p>
            <p className="text-sm text-gray-700 dark:text-gray-300 mt-4">
            ...
            <p className="text-xs text-gray-700 dark:text-gray-300 mt-2 mb-4"> figure 2. </p>
